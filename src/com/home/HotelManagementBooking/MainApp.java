...
public class MainApp {
	...
	public static void main(String[] args) {
		HotelManagementDetails hotelManagementSystem = new HotelManagementDetails();
		// Create guests
        ...
        // Create rooms
        Room room1 = new Room("R001", RoomType.GENERAL, 100.0);
        Room room2 = new Room("R002", RoomType.SUIT, 200.0);
